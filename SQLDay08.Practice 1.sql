...
SELECT * FROM workers;
​
--Toplam salary değeri 2500 üzeri olan her bir calisan için salary toplamını bulun.
...
*/
​
--salary değeri 3000'den yüksek olan state değerlerini ve salary değeri 2000'den küçük olan
--name değerlerini tekrarsız olarak bulun.
​
