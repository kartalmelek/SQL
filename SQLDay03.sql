...
__PARENT table'dan sildigimiz icin CHILD table'dan da silinmis olur
...
--Talebeler tablosundaki isim sutununa NOTT NULL kısıtlaması ekleyiniz ve 
__veri tipini VARCHAR(30) olarak değiştiriniz
